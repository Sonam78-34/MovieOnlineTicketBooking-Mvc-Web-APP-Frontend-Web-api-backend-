...
{
    /// <inheritdoc />
    public partial class Movie2Migration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reviewName1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    review1Description1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    reviewName2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    review1Description2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    reviewName3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    review1description3 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_reviewes_signups_UserId",
                        column: x => x.UserId,
                        principalTable: "signups",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
